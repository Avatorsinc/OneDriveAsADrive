...
- **Local data:** a per-install random secret, an optional `config.json` you write yourself, and a plain-text log file — all under `%LOCALAPPDATA%\OneDriveAsADrive\`, all deleted on uninstall.
